...
namespace LearningManagementSystem
{
    ...
    public partial class SelectFromDatabaseEntities : DbContext
    {
        public SelectFromDatabaseEntities()
            : base("name=SelectFromDatabaseEntities")
        {
        }
        ...
        public virtual DbSet<CourseAssignmentRoster> CourseAssignmentRosters { get; set; }
